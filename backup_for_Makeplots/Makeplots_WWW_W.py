...
#        Constrains= "&&PTj>500&&PTj_2>500&&HT>1200 "#  %s<"%(options.mass_low)+Mjmin+"&&"+Mjmin+"<%s    &&  (( Nj8==2 && %s<"%(options.mass_high,options.Dimass_low)+MJJc+"&&"+MJJc+"<%s) || ( Nj8==3 && %s<"%(options.Dimass_high,options.Dimass_low)+MJJJ+"&&"+MJJJ+"<%s)) && "%(options.Dimass_high);
        ...
        #------------------------------ SIGNAL REGIONS -----------------------------------------------
        ISR1 = common1 + " Nj8==3  &&  num_ak4jetsex<=2  &&   60<Mj_max2&&Mj_max2<100  &&  60<Mj_min2&&Mj_min2<100    &&  PTj_3/PTj<0.2                 &&  tau42_max2<"+c+"  &&  tau21_min2<"+c+"  &&  tau41_max2<"+g+" && tau41_min2<"+g+"  &&  nbtag_deep==0  ";
        ISR2 = common1 + " Nj8==3  &&  num_ak4jetsex<=2  &&  100<Mj_max2&&Mj_max2<200  &&  60<Mj_min2&&Mj_min2<100    &&  PTj_3/PTj<0.2                  &&  tau42_max2<"+c+"  &&  tau21_min2<"+c+"  &&  tau41_max2<"+g+" && tau41_min2<"+g+"  &&  nbtag_deep==0  ";
        ISR3 = common1 + " Nj8==3  &&  num_ak4jetsex<=2  &&  200<Mj_max2              &&  60<Mj_min2&&Mj_min2<100    &&  PTj_3/PTj<0.2                  &&  tau42_max2<"+c+"  &&  tau21_min2<"+c+"  &&  tau41_max2<"+g+" && tau41_min2<"+g+"  &&  nbtag_deep==0  ";
        ISR4 = common1 + " Nj8==4   &&  num_ak4jetsex<=2 && PTj_4/PTj<0.2   &&   60<Mj_mid&&Mj_max<100  &&  60<Mj_min                                                        &&  tau21_max<"+c+"  &&  tau21_mid<"+c+"  &&  tau41_max<"+g+" && tau41_mid<"+g+"  &&  nbtag_deep==0  ";
        ISR5 = common1 + " Nj8==4   &&  num_ak4jetsex<=2 && PTj_4/PTj<0.2   &&    60<Mj_mid&&Mj_max<100  &&     Mj_min<60                                                     &&  tau21_max<"+c+"  &&  tau21_mid<"+c+"  &&  tau41_max<"+g+" && tau41_mid<"+g+"  &&  nbtag_deep==0  ";
    ...
    #    if REGION == "SR1" : selection = Filters + common + Subjtns2 + Constrains +" Nj8==2 && num_ak4jetsex<=2 &&  70<"+Mjmax+"&&"+Mjmax+"<100  &&  70<"+Mjmin+"&&"+Mjmin+"<100 ";
        if REGION == "SR1" :
           #       selection1 = Filters + common + " Nj8==2  &&  num_ak4jetsex<=2  &&  70<Mj_maxc&&Mj_maxc<100  &&  70<Mj_minc&&Mj_minc<100                                            &&  jetAK8puppi_dnnDecorrW_max>"+g2+"  &&  jetAK8puppi_dnnDecorrW_min>"+g2+" &&  tau41_max<"+g+" && tau41_min<"+g+"  &&  num_bJet_tight==0  ";
                  selection1 = Filters + common + " Nj8==2  &&  num_ak4jetsex<=2  &&  60<Mj_maxc&&Mj_maxc<100  &&  60<Mj_minc&&Mj_minc<100                                            &&  jetAK8puppi_dnnDecorrW_max>"+g2+"  &&  jetAK8puppi_dnnDecorrW_min>"+options.wtag+"  &&  nbtag_deep==0  ";
        ...
        if REGION == "SR2" :
                  selection1 = Filters + common + " Nj8==2  &&  num_ak4jetsex<=2  &&  100<Mj_maxc&&Mj_maxc<200  &&  60<Mj_minc&&Mj_minc<100                                            &&  (jetAK8puppi_dnnDecorrh4q_max + jetAK8puppi_dnnDecorrw_max)/(jetAK8puppi_dnnDecorrh4q_max + jetAK8puppi_dnnDecorrw_max + jetAK8puppi_dnnDecorrqcd_max)>"+g3+"  &&  jetAK8puppi_dnnDecorrW_min>"+g2+"  &&  nbtag_deep==0  "; 
      #            selection1 = Filters + common + " Nj8==2  &&  num_ak4jetsex<=2  &&  100<Mj_maxc&&Mj_maxc<200  &&  70<Mj_minc&&Mj_minc<100                                            &&  tau42_max<"+c+"  &&  tau21_min<"+c+"  &&  tau41_max<"+g+" && tau41_min<"+g+"  &&  num_bJet_tight==0  ";
        ...
        if REGION == "SR3" : 
                  selection1 = Filters + common + " Nj8==2  &&  num_ak4jetsex<=2  &&  200<Mj_maxc              &&  60<Mj_minc&&Mj_minc<100                                            &&  (jetAK8puppi_dnnDecorrh4q_max + jetAK8puppi_dnnDecorrw_max)/(jetAK8puppi_dnnDecorrh4q_max + jetAK8puppi_dnnDecorrw_max + jetAK8puppi_dnnDecorrqcd_max)>"+g3+"  &&  jetAK8puppi_dnnDecorrW_min>"+g2+"  &&  nbtag_deep==0  "; 
#                  selection1 = Filters + common + " Nj8==2  &&  num_ak4jetsex<=2  &&  200<Mj_maxc              &&  70<Mj_minc&&Mj_minc<100                                            &&  tau42_max<"+c+"  &&  tau21_min<"+c+"  &&  tau41_max<"+g+" && tau41_min<"+g+"  &&  num_bJet_tight==0  ";
        ...
        if REGION == "SR4" :
                  selection1 = Filters + common + " Nj8==3   &&  num_ak4jetsex<=2  &&   60<Mj_mid&&Mj_max<100  &&  60<Mj_min                                                        &&  jetAK8puppi_dnnDecorrW_max>"+g2+"  &&  jetAK8puppi_dnnDecorrW_mid>"+g2+"  &&  jetAK8puppi_dnnDecorrW_min>"+g2+"   &&  nbtag_deep==0 "; 
 #                 selection1 = Filters + common + " Nj8==3   &&  num_ak4jetsex<=2  &&   70<Mj_mid&&Mj_max<100  &&  60<Mj_min                                                        &&  tau21_max<"+c+"  &&  tau21_mid<"+c+"  &&  tau41_max<"+g+" && tau41_mid<"+g+"  &&  num_bJet_tight==0  ";
        ...
        if REGION == "SR5" : 
                  selection1 = Filters + common + " Nj8==3   &&  num_ak4jetsex<=2  &&   60<Mj_mid&&Mj_max<100  &&     Mj_min<60                                                     &&  jetAK8puppi_dnnDecorrW_max>"+g2+"  &&  jetAK8puppi_dnnDecorrW_mid>"+g2+"   &&  nbtag_deep==0  &&  PTj_3/PTj>=0.2"; 
